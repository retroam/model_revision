 cd('B:\Robert\Dissertation\Beta Blocker modeling\final_model validation');
...
% 
% tspan = [2*60;6*60];
% p(1) = 0.1; p(2) = dose;  % agonist conc and beta blocker conc
...
% p(1) = 10; p(2) = dose;     % agonist conc and beta blocker conc
