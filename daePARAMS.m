function params = daePARAMS(KR,KL,KA,KG,alpha_L,alpha_A,gamma_L,gamma_A,factor)
...
%% Assemble Parameters Array
  ...
  TnItot PP2A_TnI k_PKA_TnI Km_PKA_TnI k_PP2A_TnI Km_PP2A_TnI scaling_factor ...
  ];
